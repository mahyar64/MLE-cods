/*
 Java Android SDK application for using machine learning algorithm 
 from NDK (Native Development Kit) and FANN (fastartificial neural network) 
 in c language.
 Developed by Mahyar Shahsavari, Samsung, SRUK, 2015
 */
